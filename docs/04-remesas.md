...
- Hover effect: Borde verde, sombra, se eleva ligeramente
...
- **Botón "⚙️ Cuotas de clientes"**: Botón verde a la derecha
...
- Modal con formulario:
  ...
  - **Importe (€)** (\*): Input numérico (permite decimales, min 0)
...
- Título: "Clientes"
- Campo de búsqueda: Input de texto con placeholder "Buscar por nombre..."
- Botón "＋ Añadir cliente": Botón verde
